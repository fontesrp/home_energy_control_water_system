...
static const unsigned int timeAccessQttAddr = EEPROM_TIME_HEADER_ADDR + sizeof(time_t) + 1; // Address for the number of times the EEPROM was queried for the stored time
